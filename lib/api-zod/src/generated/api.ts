...
export const ListCompaniesResponseItem = zod.object({
  ...
  "customServiceTags": zod.array(zod.string()).nullish().describe('Custom \'Other\' service tags in format \'categoryKey|custom text\''),
  "city": zod.string(),
...
export const ListCategoriesResponseItem = zod.object({
  ...
  "imageUrl": zod.string().nullish().describe('Optional image URL for the category card'),
  "slug": zod.string(),
