...
export const CATEGORIES: Category[] = [
  {
    ...
    label: { en: "Renovation & Construction", de: "Renovierung & Bau", sq: "Rinovim & Ndërtim", fr: "Rénovation & Construction" },
    tags: [
  ...
  },
  {
    ...
    tags: [
      ...
      { key: "construction_cleaning", label: { en: "Post-construction cleaning", de: "Baureinigung",     sq: "Pastrimi pas ndërtimit", fr: "Nettoyage de chantier" } },
  ...
  },
  {
    ...
    tags: [
      ...
      { key: "custom_project",  label: { en: "Special project", de: "Individuelles Projekt", sq: "Projekt i veçantë",      fr: "Projet sur mesure" } },
    ],
  },
];
