      ...
      <Shell maxW="max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
          {(["basic", "professional", "premium"] as PlanType[]).map((plan) => {
            ...
            const isLight = plan === "basic" || plan === "premium";
            ...
            return (
              ...
              >
                ...
                {/* Reg fee */}
                <div className={`text-xs mt-2 ${isPro ? "text-blue-200/70" : "text-muted-foreground"}`}>
                  + {o.regFee}
                </div>
                ...
                {isSelected && (
                  <div className={`mt-4 flex items-center gap-2 text-sm font-semibold ${isPro ? "text-white" : "text-primary"}`}>
                    ...
                    {o.chooseBtn === "Choose" ? "Selected" : o.chooseBtn === "Choisir" ? "Sélectionné" : o.chooseBtn === "Wählen" ? "Gewählt" : "Zgjedhur"}
                  </div>
                )}
              </button>
            );
