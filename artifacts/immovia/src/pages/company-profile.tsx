            ...
            >
              ...
              {!user ? (
                ...
                <div className="relative rounded-xl overflow-hidden">
                  ...
                  {/* Unlock hint — subtle, non-dominant */}
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <div className="flex items-center gap-2 bg-white/80 backdrop-blur-md border border-border/60 rounded-full px-4 py-2 shadow-sm">
